 ...
 */
export function TaskSelector({ onSelect, onShowHistory }) {
  return (
    <VStack gap={4} align="stretch" p={1}>
      ...
      <Box>
        ...
        <Button
          ...
          justifyContent="flex-start"
          width="full"
          onClick={() => onSelect(TASK_TYPES.CUSTOM_CODEBASE_TASK)}
          py={6}
          bg="purple.500"
        ...
        <VStack gap={1} mt={3} align="stretch">
          ...
          {CUSTOM_PROMPTS.map((prompt) => (
            <Text
              ...
              onClick={() => onSelect(TASK_TYPES.CUSTOM_CODEBASE_TASK, prompt)}
              noOfLines={1}
            >
              "{prompt}"
            </Text>
